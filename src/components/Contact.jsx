...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Lucas Merino",
          from_email: form.email,
          to_email: "merino.lucas20@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          toast.success("Muchas gracias! Le voy a responder en la brevedad");
        ...
        (error) => {
          ...
          toast.error("Hubo un error. Porfavor, intente nuevamente")
        }
      );
    }
    else{
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>¿Quiere seguir en contacto?</p>
